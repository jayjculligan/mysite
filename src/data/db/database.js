    ...
    workingExperience: [
      {
        ...
        details2: "• Lead the response to multiple web application attacks, working closely with external engineering and security teams - increasing Cequence’s CQ-AI consultancy and threat reporting services annual revenue by $600K+.",
        details3: "• Created a range of Kibana dashboards and automated visualizations for internal threat monitoring, system health, and external weekly threat reports."
      },
      {
        id: 2,
      ...
      {
        id: 3,
        year: "Nov 2017 - Aug 2018",
        position: "Postdoctoral Scholar",
        company: "Okinawa Institute of Science and Technology",
        details: "• Applied neural network classifiers with Keras and Tensorflow to investigate the color-changing capabilities of cuttlefish.",
        details2: "• Used Generative Adversarial Networks (GANs) to model camouflage adaptation to diverse environments based on predator visual capabilities.",
        details3: ""
      },
      {
        id: 4,
        year: "Sep 2013 - Oct 2017",
        position: "Postgraduate Researcher",
        company: "University of Sussex",
        details: "• Conducted a range of experiments using digital image analysis, inferential statistics, as well as, unsupervised and supervised models to investigate the visual and rapid camouflage capabilities of cephalopod species.",
        details2: "• Used logistic regression classification on Gabor filter outputs of cephalopod images, tuned to predator visual capabilities, to support theories on disruptive camouflage.",
        details3: "• Applied Gaussian Mixture Models (GMMs) with Principal Components Analysis (PCA) on scored images of cephalopod camouflage patterns to suggest cephalopod patterning is continuous, not discrete."
      }
    ],
    educationExperience: [
      {
